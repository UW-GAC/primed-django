...
class dbGaPWorkspaceAdapterTest(AnVILAPIMockTestMixin, TestCase):
    """Tests for methods in the dbGaPWorkspaceAdapter."""

    def setUp(self):
        super().setUp()
        self.adapter = adapters.dbGaPWorkspaceAdapter()
    ...
    def test_after_anvil_create(self):
        ...
        # Run the adapter method.
        self.adapter.after_anvil_create(dbgap_workspace.workspace)
        ...
        self.assertEqual(sharing.workspace, dbgap_workspace.workspace)
