...
class CDSAWorkspaceAdapterTest(AnVILAPIMockTestMixin, TestCase):
    """Tests for methods in the CDSAWorkspaceAdapter."""

    def setUp(self):
        super().setUp()
        self.adapter = adapters.CDSAWorkspaceAdapter()
    ...
    def test_after_workspace_create(self):
        ...
        self.assertEqual(sharing.workspace, cdsa_workspace.workspace)
