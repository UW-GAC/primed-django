# Generated by Django 3.2.16 on 2022-11-30 00:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('miscellaneous_workspaces', '0002_consortiumdevelworkspace_historicalconsortiumdevelworkspace'),
    ]

    operations = [
        migrations.CreateModel(
            name='HistoricalExampleWorkspace',
            fields=[
            ...
            options={
                'verbose_name': 'historical example workspace',
                'verbose_name_plural': 'historical example workspaces',
